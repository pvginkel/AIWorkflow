...
| [`risk_readout.py`](../research/tools/risk_readout.py) | research | spec-repo git, `state.json` telemetry, review markdown, processed close-outs | per phase what was touched, found, refuted and dispositioned, scored against a path-risk map |
