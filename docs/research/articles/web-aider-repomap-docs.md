...
# <a href="#repository-map" class="anchor-heading" aria-labelledby="repository-map"><img src="data:image/svg+xml;base64,PHN2ZyB2aWV3Ym94PSIwIDAgMTYgMTYiIGFyaWEtaGlkZGVuPSJ0cnVlIj48dXNlIHhsaW5rOmhyZWY9IiNzdmctbGluayIgLz48L3N2Zz4=" /></a> Repository map
...
Here’s a part of the repo map of aider’s repo, for [base_coder.py](https://github.com/Aider-AI/aider/blob/main/aider/coders/base_coder.py) and [commands.py](https://github.com/Aider-AI/aider/blob/main/aider/commands.py) :
...
## <a href="#more-info" class="anchor-heading" aria-labelledby="more-info"><img src="data:image/svg+xml;base64,PHN2ZyB2aWV3Ym94PSIwIDAgMTYgMTYiIGFyaWEtaGlkZGVuPSJ0cnVlIj48dXNlIHhsaW5rOmhyZWY9IiNzdmctbGluayIgLz48L3N2Zz4=" /></a> More info
