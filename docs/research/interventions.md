...
mirrored into `archive/run-1/articles/`), a survey of the current loop (`plugins/dev` at 0.4.2), and a grounding
sample of five recent slice runs (KubeCoderSpecs 149–153). The per-paper extraction reports behind
every citation here live in [archive/run-1/extracts/](archive/run-1/extracts/).
