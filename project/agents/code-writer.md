...
4. **No scope bleed.** Implement only what's described. No adjacent refactors, no "while I'm here" improvements, no drive-by fixes — those belong in their own change.
